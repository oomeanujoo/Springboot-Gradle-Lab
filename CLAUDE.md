...
*(This file mirrors `AGENTS.md` — the canonical source. Update both together
if these rules change; Claude Code reads this file specifically, Codex and
other AGENTS.md-aware tools read the other. `.clinerules/project-rules.md`
mirrors both for Cline; `.github/copilot-instructions.md` and `.cursorrules`
are thin pointers back to `AGENTS.md` for Copilot/Cursor.)*
